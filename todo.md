# CompuNerd Ghana Job Worker - Development TODO

## Phase 1: Project Setup & Branding
- [x] Upload and set up logo as app branding
- [x] Configure corporate purple color palette in Tailwind
...
- [x] Create users table with roles (Admin, Manager, Field Engineer, Finance)
- [x] Create clients table (CRM)
- [x] Create jobs/tickets table with status workflow
- [x] Create devices/assets table
- [x] Create inventory/stock items table
- [x] Create field engineers table
- [x] Create financial records table
- [x] Create staff/employees table
- [x] Create payroll table
- [x] Create activity logs table

## Phase 3: Dashboard & Navigation
- [x] Build main dashboard with KPI cards
- [x] Implement recent activity feed
- [x] Create sidebar navigation with role-based menu items
- [x] Set up dashboard layout for all pages
